...
const App = () => {
  ...
  const defaultMagazineItem = 'Winter2023Container'; // Set the default magazine item here
  ...
  return (
    <View style={styles.fullScreenContainer}>
      <View style={styles.centeredContainer}>
        {magazineItem === 'LoadingContainer' && <LoadingContainer />}
        {magazineItem === 'Winter2023Container' && <Winter2023Container />}
      </View>
    </View>
  );
};
